...
const CatalogForm = ({ item, onSuccess, onCancel }) => {
            ...
            <div className="bg-white rounded-lg shadow-xl max-w-lg w-full max-h-[90vh] overflow-y-auto">
                <div className="p-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            <label htmlFor="plataform" className="block text-sm font-medium text-gray-700 mb-1">
                                Plataforma *
                            </label>
                            <input
                                type="text"
